...
class toplistcategories extends StatefulWidget {
  ...
  @override
  State<toplistcategories> createState() => _toplistcategoriesState();
}

class _toplistcategoriesState extends State<toplistcategories> {
  FirebaseServices _service = FirebaseServices();

  DeleteCategory(id) async {
    _service.Polygon_Cliper.doc(id).delete();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: _service.Polygon_Cliper.snapshots(),
